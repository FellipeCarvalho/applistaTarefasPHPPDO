	...
	<head>
		...
		<script>
				...
				function editaTarefa(idTarefa, textTarefa){
					...
					form.action = 'tarefas_controller.php?acao=atualizar&pag=index' //add parametro pag=index para voltar para pagina index
					form.method = 'post'
					form.className = 'row'
				...
				function deletaTarefa(id){
					//redireciona para página de controle, adicionei um parametro pag=index para voltar para pagina index
					location.href = 'tarefas_controller.php?acao=deletar&id='+id+'&pag=index'
				...
				function finalizarTarefa(id){
					//redireciona para página de controle, adicionei um parametro pag=index para voltar para pagina index
					location.href = 'tarefas_controller.php?acao=finalizar&id='+id+'&pag=index'
